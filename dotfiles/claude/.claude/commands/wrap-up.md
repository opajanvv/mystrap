...
End a phase, feature, or project with a clean handoff.

## Instructions

Run these steps in order:

1. **Commit current work**: Run `/commit-and-push` to commit any pending changes from the work just completed.
...
5. **Exit**: End the session. The work is wrapped up and ready for next time.

If any step has nothing to do (no changes to commit, no improvements to make), skip it and move on.
